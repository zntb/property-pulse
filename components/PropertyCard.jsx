  ...
  return (
    <div className="rounded-xl shadow-md relative">
      ...
      <div className="p-4">
        ...
        <h3
          className="absolute top-[10px] right-[10px] bg-white px-4 py-2 rounded-lg text-blue-500
        ...
        <div className="flex flex-col lg:flex-row justify-between mb-4">
          ...
          <Link
            ...
            className="h-[36px] bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg
              text-center text-sm"
          >
            Details
          </Link>
