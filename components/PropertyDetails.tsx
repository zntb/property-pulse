    ...
    <main>
      <div className="bg-white p-6 rounded-lg shadow-md text-center md:text-left">
        ...
        <div className="flex flex-col md:flex-row justify-around">
          <div
            className="flex items-center justify-center mb-4 border-b border-gray-200 md:border-b-0
              pb-4 md:pb-0"
          >
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mt-6">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center list-none space-y-2">
