...
const Navbar = () => {
  ...
  return (
    <nav
      className={`bg-blue-700 border-b border-blue-500 fixed top-0 z-50 w-full transition-opacity
        duration-500 ease-in-out ${showNavigation ? "opacity-100" : "opacity-0"}`}
    >
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-20 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center md:items-stretch md:justify-start">
            ...
            <div className="hidden md:ml-6 md:block">
              <div className="flex space-x-2">
                <Link
                  href="/"
                  className={`${pathname === "/" ? "bg-black" : ""} text-white hover:bg-gray-900
                ...
                <Link
                  href="/properties"
                  className={`${pathname === "/properties" ? "bg-black" : ""} text-white hover:bg-gray-900
                    hover:text-white rounded-md px-3 py-2`}
                >
                  Properties
                </Link>
                {session && (
                  <Link
                    href="/properties/add"
                    className={`${pathname === "/properties/add" ? "bg-black" : ""} text-white hover:bg-gray-900
                    hover:text-white rounded-md px-3 py-2`}
                  >
                    Add Property
                  </Link>
          ...
          {session && (
            <div
              className="absolute inset-y-0 right-0 flex items-center pr-2 md:static md:inset-auto
                md:ml-6 md:pr-0"
            >
      ...
      {isMobileMenuOpen && (
        <div id="mobile-menu">
          <div className="space-y-1 px-2 pb-3 pt-2 border-t border-blue-500">
            <Link
              href="/"
              className={`${pathname === "/" ? "bg-black" : ""} text-white block rounded-md px-3 py-2
            ...
            <Link
              href="/properties"
              className={`${pathname === "/properties" ? "bg-black" : ""} text-white block rounded-md px-3
            ...
            {session && (
              <Link
                href="/properties/add"
                className={`${pathname === "/properties/add" ? "bg-black" : ""} text-white block rounded-md
